...
var Module = typeof TrichiJs != 'undefined' ? TrichiJs : {};
...
var wasmBinaryFile;
if (Module['locateFile']) {
  wasmBinaryFile = 'trichi-wasm.wasm';
  if (!isDataURI(wasmBinaryFile)) {
    wasmBinaryFile = locateFile(wasmBinaryFile);
  }
} else {
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  wasmBinaryFile = new URL('trichi-wasm.wasm', import.meta.url).toString();
}
...
run();
  ...
  return TrichiJs.ready
}
);
})();
export default TrichiJs;